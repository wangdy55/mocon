...
from utils.BvhMotion import BvhMotion
from .mocap_utils import blend_two_motions
from mocon.motion.utils.QuatUtil import QuatUtil

class MotionCtrl:
    def __init__(self) -> None:
        self.motions = []
        self.motions.append(BvhMotion('assets/motion_material/walk_forward.bvh'))
        self.motions.append(BvhMotion('assets/motion_material/idle.bvh'))
        self.motion_id = 0
        ...
        self.idle2move_motion = blend_two_motions(self.motions[1], self.motions[0], 60, 30)
        self.move2idle_motion = blend_two_motions(self.motions[0], self.motions[1], 60, 30)
    ...
    def update_state(self, 
        ...
        if self.motion_state == "move":
            ...
            current_motion_avel = quat2avel(current_motion.joint_rotation[:, 0, :], 1 / 60)
            ...
            if self.motion_state != last_motion_state: # switch to idle
